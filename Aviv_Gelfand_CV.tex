...
\begin{document}
    ...
    \section{Experience}
        ...
        \textit{Oct 2023 – May 2024}}
            ...
            \textit{The Hebrew University of Jerusalem, Prof. Adi Leibovitch's Quantitative Legal Research Lab}
        \end{twocolentry}
        ...
        \textit{Apr 2022 – Mar 2023}}
            ...
            \textit{The Hebrew University of Jerusalem, Renana Peres' Computational lab}
        \end{twocolentry}
    ...
    \section{Skills and Technologies}
        ...
        \begin{onecolentry}
            \textbf{ETL:} Basic and complex Visualizations, Advanced Statistical Inference, Cleaning, Encoding / Embedding, Imputing
        \end{onecolentry}
    ...
    \section{Notable Projects}
        ...
        \textit{\href{https://github.com/AvivGelfand/HUJI-Moodle-Bot}{GitHub Repo}}}
            \textbf{Alfred - University Tasks Personal Asistant}
        \end{twocolentry}
